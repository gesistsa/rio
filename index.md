...
- [`import()`](http://gesistsa.github.io/rio/reference/import.md)
  provides a painless data import experience by automatically choosing
  the appropriate import/read function based on file extension (or a
  specified `format` argument)
- [`export()`](http://gesistsa.github.io/rio/reference/export.md)
  provides the same painless file recognition for data export/write
  functionality
...
[`export()`](http://gesistsa.github.io/rio/reference/export.md) can also
write multiple data frames to respective sheets of an Excel workbook or
an HTML file:
...
allows users to import a list of data frames from a multi-object file
(such as an Excel workbook, .Rdata file, zip directory, or HTML file):
